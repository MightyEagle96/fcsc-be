...
const emailTemplate = (name, password, appLink) => `<!DOCTYPE html>
          ...
          >
            ...
            <tr>
              <td
                ...
                "
              >
                <p style="margin: 0 0 15px 0; text-transform: capitalize">Dear ${name},</p>
                <p style="margin: 0 0 15px 0">
                  Your account has been successfully created.<br />
                  You have been provisioned with a password:
                </p>
                <p
                  style="
                    margin: 0 0 20px 0;
